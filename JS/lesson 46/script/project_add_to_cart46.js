...
class cardProduct{
    ...
    // объявление и отображение данных
    ...
    render(){
        ...
        div.innerHTML = ` 
                        ...
                        <div class="body_item">
                            ...
                            <div class="price">
                                <span class="currency">$</span>
                                <span class="span_price">${this.originPrice}</span>
                                <del class="del_price">$ ${this.oldPrice}</del>
                            </div>
